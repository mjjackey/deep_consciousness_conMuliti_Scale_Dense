...
from models.msdnet_layers import MSDLayer,MSDFirstLayer,CifarClassifier,Transition
...
class MSDNet(nn.Module):
    ...
    def build_modules(self, num_channels):
        ...
        for i in range(0, self.num_blocks):
            ...
            ########## Add a classifier that belongs to the i'th block3 ###########
    ...
    def create_block(self, num_channels, block_num):
        ...
        for _ in range(0, self.steps[block_num]):
            ...
            # Add an MSD layer, build in function
    ...
    def forward(self, x, progress=None):
        ...
        for block_num in range(0, self.num_blocks):
            ...
            #         print("- Output size of this block's scale {}: ".format(s),b.size())
